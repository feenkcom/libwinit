...
#[no_mangle]
pub extern fn winit_create_window(
...
#[no_mangle]
pub extern fn winit_windowed_context_raw_window_handle(
...
#[no_mangle]
pub extern fn winit_window_request_redraw(window: *mut ValueBox<Window>) {
    window.with_ref(Window::request_redraw).log();
}

#[no_mangle]
pub extern fn winit_window_get_scale_factor(window: *mut ValueBox<Window>) -> f64 {
    window.with_ref(Window::scale_factor).or_log(1.0)
}

#[no_mangle]
pub extern fn winit_window_get_inner_size(
...
#[no_mangle]
pub extern fn winit_window_set_inner_size(window: *mut ValueBox<Window>, width: u32, height: u32) {
    window
...
#[no_mangle]
pub extern fn winit_window_get_position(
    window_ptr: *mut ValueBox<Window>,
...
#[no_mangle]
pub extern fn winit_window_set_position(window: *mut ValueBox<Window>, x: i32, y: i32) {
    window
...
#[no_mangle]
pub extern fn winit_window_get_id(window_ptr: *mut ValueBox<Window>, id_ptr: *mut ValueBox<U128Box>) {
    window_ptr.with_not_null(|window| {
...
#[no_mangle]
pub extern fn winit_window_set_title(
    window_ptr: *mut ValueBox<Window>,
...
#[no_mangle]
pub extern fn winit_window_set_cursor_icon(
    window_ptr: *mut ValueBox<Window>,
...
#[no_mangle]
pub extern fn winit_window_set_maximized(window_ptr: *mut ValueBox<Window>, maximized: bool) {
    window_ptr.with_not_null(|window| {
...
#[cfg(target_os = "windows")]
#[no_mangle]
pub extern fn winit_window_get_hwnd(window_ptr: *mut ValueBox<Window>) -> *mut std::ffi::c_void {
...
#[no_mangle]
pub extern fn winit_window_builder_with_full_size(
...
#[cfg(target_os = "macos")]
#[no_mangle]
pub extern fn winit_window_get_ns_view(window_ptr: *mut ValueBox<Window>) -> cocoa::base::id {
...
#[no_mangle]
pub extern fn winit_window_drop(ptr: *mut ValueBox<Window>) {
    ptr.release();
}
